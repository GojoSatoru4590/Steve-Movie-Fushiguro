...
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1003578734469"))
...
#Database --⚠️ REQUIRED--
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://adamopytbusiness1:uSswEjo4ZHMGDU8Z@cluster0.gqgmk.mongodb.net/?retryWrites=true&w=majority&appName=SteveFileStoreBot")
DB_NAME = os.environ.get("DATABASE_NAME", "Steve_File_Store_Bot")
